 ...
 * $Id: Osci.cpp 21283 2014-03-06 11:23:30Z ritt $
 */
            ...
            if (m_chnOn[b][i]) {
               ...
               for (int j=0 ; j<m_waveDepth ; j++) {
                  ...
                  if (m_waveDepth == 2048) {
                     ...
                     d = (unsigned short)(((m_waveform[b][i][j]+m_waveform[b][i][j+1])/2000.0 + 0.5) * 65535);
                     *(unsigned short *)p = d;
                     p += sizeof(unsigned short);
                     j++;
                  } else {
                     d = (unsigned short)((m_waveform[b][i][j]/1000.0 + 0.5) * 65535);
                     *(unsigned short *)p = d;
                     p += sizeof(unsigned short);
                  }
               }
