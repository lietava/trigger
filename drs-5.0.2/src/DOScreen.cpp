 ...
 * $Id: DOScreen.cpp 21282 2014-03-06 10:13:43Z ritt $
 */
...
void DOScreen::DrawScope(wxDC& dc, wxCoord width, wxCoord height, bool printing)
{
   ...
   if (m_frame->IsStat() && n > 0) {
      dc.SetTextForeground(*wxGREEN);
      dc.DrawText(wxT("     Min      Max     Mean      RMS      N"), m_x1[m_board]+nameWidth+valueWidth, y_top);
      dc.GetTextExtent(wxT("     Min      Max     Mean      RMS      N"), &w, &h);
...
void DOScreen::DrawHisto(wxDC& dc, wxCoord width, wxCoord height, bool printing)
{
   ...
   if (m_frame->IsStat()) {
      dc.SetTextForeground(*wxGREEN);
      dc.DrawText(wxT("     Min      Max     Mean      RMS      N"), m_hx1, y_top);
