 ...
 * $Id: DOFrame.cpp 21309 2014-04-11 14:51:29Z ritt $
 */
...
char svn_revision[] = "$Id: DOFrame.cpp 21309 2014-04-11 14:51:29Z ritt $";

char drsosc_version[] = "5.0.2";
...
DOFrame_fb( parent )
{
   ...
   if (m_osci->GetBoard(0)->Is2048ModeCapable())
      m_chnSection = 2;
   else
      m_chnSection = 0;
